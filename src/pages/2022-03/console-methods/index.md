...
```js
console.log("String: %s, Int: %d, Decimal: %f, Object: %o", "Hello", 1, 0.1, {
  name: "Kyle",
})
...
_If you are unfamiliar with this syntax you can check out my complete [tagged template literals article](/2020-03/tagged-template-literals/)._
