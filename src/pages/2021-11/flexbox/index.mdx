...
import FlexboxGeneric from "@blogComponents/flexbox/FlexboxGeneric.astro"
import FlexboxAxes from "@blogComponents/flexbox/FlexboxAxes.astro"
...
<FlexboxGeneric
  align="stretch"
  variedHeight
  firstElementStyles="height: initial;"
/>
...
<FlexboxGeneric
  firstElementStyles="flex-grow: 1;"
  secondElementStyles="flex-grow: 1;"
/>
...
<FlexboxGeneric
  firstElementStyles="flex-grow: 2;"
  secondElementStyles="flex-grow: 1;"
/>
...
<FlexboxGeneric
  firstElementStyles="width: 10%;"
  secondElementStyles="width: 20%;"
  thirdElementStyles="width: 30%;"
/>
...
<FlexboxGeneric
  firstElementStyles="width: 10%; flex-grow: 1;"
  secondElementStyles="width: 20%; flex-grow: 1;"
  thirdElementStyles="width: 30%; flex-grow: 1;"
/>
...
<FlexboxGeneric
  firstElementStyles="flex-basis: 0; flex-grow: 1;"
  secondElementStyles="flex-basis: 0; flex-grow: 1;"
  thirdElementStyles="flex-basis: 0; flex-grow: 1;"
/>
