...
_If you are unfamiliar with all the nuances of the `transform` property check out my [Ultimate CSS Transform Guide](/2021-01/css-transform) before reading further._
...
.box {
  ...
  height: 200px;
  background: red;
  transform: scale(var(--scale, 1)) translate(var(--translate, 0)) rotate(var(--rotate, 0));
}
