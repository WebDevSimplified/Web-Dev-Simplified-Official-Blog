...
import FlexboxGeneric from "../../../../src/blogComponents/flexbox/FlexboxGeneric"
import FlexboxAxes from "../../../../src/blogComponents/flexbox/FlexboxAxes"
...
<FlexboxGeneric align="stretch" variedHeight elementProps={[{ height: "initial" }]} />
...
<FlexboxGeneric variedHeight elementProps={[{ alignSelf: "flex-end" }]} />
...
<FlexboxGeneric elementProps={[{}, { flexGrow: 1 }]} />
...
<FlexboxGeneric elementProps={[{ flexGrow: 1 }, { flexGrow: 1 }]} />
...
<FlexboxGeneric elementProps={[{ flexGrow: 2 }, { flexGrow: 1 }]} />
...
<FlexboxGeneric elementProps={[{ flexBasis: "40%" }]} />
...
<FlexboxGeneric elementProps={[{ width: "10%" }, { width: "20%" }, { width: "30%" }]} />
...
<FlexboxGeneric elementProps={[{ flexGrow: 1, width: "10%" }, { flexGrow: 1, width: "20%" }, { flexGrow: 1, width: "30%" }]} />
...
<FlexboxGeneric elementProps={[{ flexGrow: 1, flexBasis: 0 }, { flexGrow: 1, flexBasis: 0 }, { flexGrow: 1, flexBasis: 0 }]} />
...
<FlexboxGeneric width="50%" elementProps={[{ flexShrink: 0 }]} />
...
<FlexboxGeneric width="50%" elementProps={[{ flexShrink: 2 }]} />
...
<FlexboxGeneric elementProps={[{ order: 2 }]} />
