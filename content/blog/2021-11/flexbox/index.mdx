...
import Flexbox from "../../../../src/blogComponents/flexbox/FlexboxGeneric"
...
Even though we set the width to 50% above the items have their size reduced to 33% each to fit within the container.
...
<Flexbox withCrossAxis withMainAxis />
...
```
<Flexbox align="stretch" variedHeight elementProps={[{ height: "initial" }]} />
...
```
<Flexbox align="flex-start" variedHeight />
...
```
<Flexbox align="flex-end" variedHeight />
...
```
<Flexbox align="center" variedHeight />
...
```
<Flexbox direction="row" variedHeight />
...
```
<Flexbox direction="row-reverse" variedHeight />
...
```
<Flexbox direction="column-reverse" align="center" />
...
```
<Flexbox variedHeight elementProps={[{ alignSelf: "flex-end" }]} />
...
<Flexbox elementProps={[{}, { flexGrow: 1 }]} />
...
<Flexbox elementProps={[{ flexGrow: 1 }, { flexGrow: 1 }]} />
...
<Flexbox elementProps={[{ flexGrow: 2 }, { flexGrow: 1 }]} />
...
```
<Flexbox elementProps={[{ flexBasis: "40%" }]} />
...
<Flexbox elementProps={[{ width: "10%" }, { width: "20%" }, { width: "30%" }]} />
...
```
<Flexbox elementProps={[{ flexGrow: 1, width: "10%" }, { flexGrow: 1, width: "20%" }, { flexGrow: 1, width: "30%" }]} />
...
```
<Flexbox elementProps={[{ flexGrow: 1, flexBasis: 0 }, { flexGrow: 1, flexBasis: 0 }, { flexGrow: 1, flexBasis: 0 }]} />
...
```
<Flexbox width="50%" elementProps={[{ flexShrink: 0 }]} />
...
```
<Flexbox width="50%" elementProps={[{ flexShrink: 2 }]} />
...
<div style={{ height: "250px", marginBottom: "1rem" }}>
  <Flexbox width="auto" height="100px" wrap="wrap" direction="column" />
</div>
...
```
<div style={{ height: "250px", marginBottom: "1rem" }}>
  <Flexbox width="50%" alignContent="flex-end" height="100px" wrap="wrap" />
</div>
...
```
<div style={{ height: "250px", marginBottom: "1rem" }}>
  <Flexbox height="100px" wrap="wrap" direction="column" alignContent="center" />
</div>
...
```
<div style={{ height: "250px", marginBottom: "1rem" }}>
  <Flexbox height="100px" wrap="wrap" direction="column" alignContent="center" gap="10px" />
</div>
...
```
<div style={{ height: "250px", marginBottom: "1rem" }}>
  <Flexbox height="100px" wrap="wrap" direction="column" alignContent="center" rowGap="10px" />
</div>
...
```
<div style={{ height: "250px", marginBottom: "1rem" }}>
  <Flexbox height="100px" wrap="wrap" direction="column" alignContent="center" columnGap="10px" />
</div>
